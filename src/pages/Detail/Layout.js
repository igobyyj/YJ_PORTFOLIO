...
const ItemContainer = styled.div`
  display: flex;
  align-items: center;
  margin: ${(props) => (props.margin ? props.margin : "70px 160px 30px 160px")};
  text-align: center;
    ...
    return (
      ...
      >
        {window.innerWidth > 1200 ? (
          <Time
            className="dropdown"
            background={this.props.background === "#000" ? "#fff" : "#000"}
            color={this.props.background === "#000" ? "#000" : "#fff"}
          >
            {this.state.date}
            <div
        ...
        <ItemContainer margin={this.props.margin} className={this.props.id}>
          {this.props.item.type === "iframe" ? (
            <IframeContainer
              type={this.props.item.type}
              padding={this.props.padding}
              minHeight={this.props.id === "message" ? "75vh" : "60vh"}
            >
              {this.props.item}
            </IframeContainer>
          ) : (
        ...
        {!["love", "toilet", "message"].includes(this.props.id) && (
          <>
            {[...Array(Number(this.props.total)).keys()].map((el, i) => {
              return (
                <BottomContainer
                  key={el}
                  padding={
                    this.props.id === "beauty" && ![0, 1, 2].includes(i)
                      ? "30px 25% 0"
                      : this.props.id === "beauty" && i === 2
                      ? "30px 37% 0"
